...
const FavBook = () => {
  return (
    <div className='px-4 lg:px-24 my-20 flex flex-col md:flex-row justify-between items-center gap-12'>
        ...
        <p className='mb-10 text-lg md:w-5/6'>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Doloremque necessitatibus recusandae, dolor eos quia eveniet possimus sunt voluptatibus voluptates impedit iusto enim. Autem tempora placeat sapiente aliquid quisquam dolorum rem?</p>
